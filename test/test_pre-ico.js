...
//     const value = ether(0.000000000000001)
...
//             const { logs } = await this.mowjowCrowdsale.buyTokens(investor, { maxPayment, from: purchaser })
//             //console.log("logs", logs)
//             const event = logs.find(e => e.event === 'PreIcoPurchase')
//             should.exist(event)
//             event.args.beneficiary.should.be.bignumber.equal(investor)
//             //event.args.value.should.be.bignumber.equal(value)
//             event.args.amount.should.be.bignumber.equal(0)
